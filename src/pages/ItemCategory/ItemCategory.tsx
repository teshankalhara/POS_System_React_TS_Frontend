                    ...
                    <div className="flex items-center justify-center">
                        <form className="border border-slate-200 rounded-lg max-w-[500px] min-w-[400px] center p-4 shadow-lg">
                            <div>
                                ...
                                <input className="text-slate-600 font-sm block mb-2 w-full p-2 border border-slate-300 rounded-lg" type="text" onChange={handleCategoryName} value={categoryName} placeholder="Enter Category Name" required />
                            </div>
